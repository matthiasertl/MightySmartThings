 ...
 */
metadata {
   definition (name: "Xiaomi Aqara Door/Window Sensor REVERSE", namespace: "a4refillpad", author: "a4refillpad") {
   ...
   simulator {
      status "closed": "on/off: 1"
      status "open": "on/off: 0"
   }
   ...
   tiles(scale: 2) {
      ...
      standardTile("icon", "device.refresh", inactiveLabel: false, decoration: "flat", width: 4, height: 1) {
            state "default", label:'Last Closed:', icon:"st.Entertainment.entertainment15"
      }
