...
metadata {
	...
	standardTile("stati", "device.acceleration", width: 6, height: 1, canChangeIcon: true) {
			state "inactive", label: 'Standby', icon: "st.switches.switch.on", backgroundColor: "#FFA500"
            state "active", label: 'Betrieb', icon: "st.switches.switch.on", backgroundColor: "#79b821"
		}
		...
		main "stati"
		details(["status", "stati", "refresh", "prevEnergyDuration", "prevEnergy", "prevEnergyCost", "resetEnergy", "energyDuration", "energy", "energyCost", "resetPower", "power", "powerL", "powerH", "resetVoltage", "voltage", "voltageL", "voltageH", "resetCurrent", "current", "currentL", "currentH"])
	}
}
...
private getInactiveCurrentOptions() {
	return [
        ...
        [name: "Less than 0,05 Amp", value: 0.05],
